"""
Django settings for cfe_eCommerce project.
...
SECRET_KEY = '5u9ui2#va*ewom-8loqs@$qbzkvvf=e*g*d!=9_wq83*ta8c%k'
...
ROOT_URLCONF = 'cfe_eCommerce.urls'
...
WSGI_APPLICATION = 'cfe_eCommerce.wsgi.application'
